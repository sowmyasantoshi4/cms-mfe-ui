                        ...
                        <fieldset className='bg-light p-3'>
                          ...
                          <Row>
                            <Col>
                              ...
                              <Form.Text className='fw-bold text-primary'>{d.s_branch}</Form.Text>
                            </Col>
                            <Col>
                          ...
                          {console.log(allowUpdate, currentStatusId)}
                              ...
                              <Row>
                                ...
                                <Col>
                                  {allowUpdate && d.currentStatusId === '3' && data.status_id === "4" ? (
                                    <Form.Group controlId="r_staff_member">
                                      ...
                                      {errors && errors.r_staff_member && (
                                        <Form.Control.Feedback type="invalid">{errors.r_staff_member}</Form.Control.Feedback>
                                      )}
                                    </Form.Group>
                                  ) : (
                                    <>
